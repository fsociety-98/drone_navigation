...
def main():
    ...
    rospy.init_node('go_to_point_0')

    pub = rospy.Publisher('/uav0/cmd_vel', Twist, queue_size=1)

    arrpub = rospy.Publisher('/uav0/array',Int32MultiArray,queue_size = 100)

    arrsub2 = rospy.Subscriber('/uav1/array',Int32MultiArray,clbk_array)
    arrsub3 = rospy.Subscriber('/uav2/array',Int32MultiArray,clbk_array)

    sub_odom = rospy.Subscriber('/uav0/ground_truth_to_tf/pose', PoseStamped, clbk_odom)

    srv = rospy.Service('go_to_point_switch0', SetBool, go_to_point_switch1)
